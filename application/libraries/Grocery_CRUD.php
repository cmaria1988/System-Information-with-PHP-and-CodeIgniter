...
class grocery_CRUD_Model_Driver extends grocery_CRUD_Field_Types
{
	...
	protected function ajax_relation($state_info)
	{
		...
		//list($field_name, $related_table, $related_field_title, $where_clause, $)  = $this->relation[$state_info->field_name];
...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	protected function delete_layout($delete_result = true)
	{
		...
		//add 16.1.21
		}elseif(isset($delete_result['status'])){
		   //TODO:custom error
		   $error_message = '<p>'.$delete_result['message']. '</p>';
		   echo json_encode(array(
		  'success' => $delete_result['status'] ,
	...
	protected function insert_layout($insert_result = false)
	{
		...
		if($insert_result === false)
		{
			echo json_encode(array('success' => false));
					//add 15.1.2020
		}else if(isset($insert_result['status'])){
			//todo: custom error
			$error_message = '<p>'.$insert_result['message'].'</p>';
			echo json_encode(array(
